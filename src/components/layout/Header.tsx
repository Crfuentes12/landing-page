    ...
    >
      ...
      >
        <div className="px-6 py-4 space-y-4">
          <a href="#about" className="block py-2 text-sm hover:text-primary">About</a>
          <a href="#services" className="block py-2 text-sm hover:text-primary">Services</a>
          <a href="#pricing" className="block py-2 text-sm hover:text-primary">Pricing</a>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-xl">YourLogo</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm text-muted-foreground hover:text-primary">Services</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm text-muted-foreground hover:text-primary">Mobile Apps</a></li>
              <li><a href="#" className="text-sm text-muted-foreground hover:text-primary">Cloud Solutions</a></li>
              <li><a href="#" className="text-sm text-muted-foreground hover:text-primary">Digital Marketing</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="mailto:contact@example.com" className="text-sm text-muted-foreground hover:text-primary">contact@example.com</a></li>
            </ul>
          </div>
        </div>
