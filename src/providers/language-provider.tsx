...
const translations = {
  en: {
    ...
    "faq.answers.fulldev": "Absolutely! If your MVP proves successful, we can continue working with you to scale it into a <strong>fully developed product</strong>—adding new features, integrations, and optimizations to support your growth. We're with you every step of the way, from MVP to market leader.",
  ...
  es: {
    ...
    "faq.answers.fulldev": "¡Absolutamente! Si tu MVP tiene éxito, podemos continuar trabajando contigo para escalarlo a un <strong>producto completamente desarrollado</strong>—agregando nuevas características, integraciones y optimizaciones para apoyar tu crecimiento. Estamos contigo en cada paso del camino, desde el MVP hasta el liderazgo en el mercado.",
