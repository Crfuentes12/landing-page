...
const translations = {
  en: {
    ...
    "why.paragraph2.part1": "We know the frustration of having a groundbreaking idea but being ",
    "why.paragraph2.part2": "held back by unnecessary complexity",
    "why.paragraph2.part3": ". That's why we're here—to ",
    "why.paragraph2.part4": "break down these barriers",
    ...
    "roadmap.feature1.description.part1": "We understand that every great product starts with a visionary idea. Our focus is on ",
    "roadmap.feature1.description.part2": "preserving your vision",
    "roadmap.feature1.description.part3": " while making it market-ready.",
    
    "roadmap.feature2.title": "Efficient Development",
    "roadmap.feature2.description.part1": "",
    "roadmap.feature2.description.part2": "No unnecessary features",
    "roadmap.feature2.description.part3": ". We build exactly what you need to validate your idea and enter the market confidently.",
    
    "roadmap.feature3.title": "Future-Proof Foundation",
    "roadmap.feature3.description.part1": "While we focus on MVP essentials, we ensure your software is ",
    "roadmap.feature3.description.part2": "solid and scalable",
    "roadmap.feature3.description.part3": " for future growth.",
    
    // Roadmap Steps
    "roadmap.step.label": "Step",
    "roadmap.step1.title": "Idea Analysis",
    "roadmap.step1.description.part1": "1. We dive into your vision to ",
    "roadmap.step1.description.part2": "understand your needs and analyze your market",
    "roadmap.step1.description.part3": ".",
    ...
    "roadmap.step2.description.part1": "2. We trim the excess and ",
    "roadmap.step2.description.part2": "focus on what truly matters",
    "roadmap.step2.description.part3": " for your MVP success",
    ...
    "roadmap.step3.description.part1": "3. We define clear project limits, ",
    "roadmap.step3.description.part2": "timeline and key deliverables",
    "roadmap.step3.description.part3": " to ensure efficient development.",
    ...
    "roadmap.step4.description.part1": "4. We provide you with a transparent progress, including ",
    "roadmap.step4.description.part2": "close collaboration and regular updates",
    "roadmap.step4.description.part3": ". You are always in control!",
    ...
    "roadmap.step5.description.part1": "5. We ",
    "roadmap.step5.description.part2": "deliver your MVP",
    "roadmap.step5.description.part3": ", ready to hit the market. If needed, we ",
    "roadmap.step5.description.part4": "provide you with ongoing support",
    "roadmap.step5.description.part5": " and guidance",
    ...
    "about.description.part1": "We combine ",
    "about.description.part2": "deep technical expertise",
    "about.description.part3": " with ",
    "about.description.part4": "startup experience",
    "about.description.part5": " to transform your vision into reality.",
  ...
  es: {
    ...
    "why.paragraph2.part1": "Conocemos la frustración de tener una idea revolucionaria pero ser ",
    "why.paragraph2.part2": "limitados por complejidades",
    "why.paragraph2.part3": " innecesarias. Por eso estamos aquí: para ",
    "why.paragraph2.part4": "derribar estas barreras",
    ...
    "roadmap.feature1.description.part1": "Entendemos que todo gran producto comienza con una idea visionaria. Nuestro enfoque está en ",
    "roadmap.feature1.description.part2": "preservar tu visión",
    "roadmap.feature1.description.part3": " mientras la hacemos lista para el mercado.",
    
    "roadmap.feature2.title": "Desarrollo Eficiente",
    "roadmap.feature2.description.part1": "",
    "roadmap.feature2.description.part2": "Sin funcionalidades innecesarias",
    "roadmap.feature2.description.part3": ". Construimos exactamente lo que necesitas para validar tu idea y entrar al mercado con confianza.",
    
    "roadmap.feature3.title": "Base Preparada para el Futuro",
    "roadmap.feature3.description.part1": "Mientras nos concentramos en lo esencial del MVP, nos aseguramos de que tu software sea ",
    "roadmap.feature3.description.part2": "sólido y escalable",
    "roadmap.feature3.description.part3": " para el crecimiento futuro.",
    
    // Roadmap Steps
    "roadmap.step.label": "Paso",
    "roadmap.step1.title": "Análisis de Ideas",
    "roadmap.step1.description.part1": "1. Profundizamos en tu visión para ",
    "roadmap.step1.description.part2": "entender tus necesidades y analizar tu mercado",
    "roadmap.step1.description.part3": ".",
    ...
    "roadmap.step2.description.part1": "2. Eliminamos lo superfluo y nos ",
    "roadmap.step2.description.part2": "enfocamos en lo que realmente importa",
    "roadmap.step2.description.part3": " para el éxito de tu MVP",
    ...
    "roadmap.step3.description.part1": "3. Definimos límites claros del proyecto, ",
    "roadmap.step3.description.part2": "cronograma y entregables",
    "roadmap.step3.description.part3": " clave para asegurar un desarrollo eficiente.",
    ...
    "roadmap.step4.description.part1": "4. Te proporcionamos un progreso transparente, incluyendo ",
    "roadmap.step4.description.part2": "colaboración cercana y actualizaciones regulares",
    "roadmap.step4.description.part3": ". ¡Siempre tienes el control!",
    ...
    "roadmap.step5.description.part1": "5. ",
    "roadmap.step5.description.part2": "Entregamos tu MVP",
    "roadmap.step5.description.part3": ", listo para salir al mercado. Si es necesario, te ",
    "roadmap.step5.description.part4": "proporcionamos soporte",
    "roadmap.step5.description.part5": " y orientación continuos",
    ...
    "about.description.part1": "Combinamos ",
    "about.description.part2": "experiencia técnica",
    "about.description.part3": " profunda con ",
    "about.description.part4": "experiencia en startups",
    "about.description.part5": " para transformar tu visión en realidad.",
    ...
    "comparison.our.service": "Nosotros",
    "comparison.traditional": "Agencias",
    ...
    "faq.subtitle": "FAQ",
    "faq.description": "Encuentra respuestas a las dudas más comunes sobre cómo desarrollamos MVPs y nuestros servicios. ¿No encuentras lo que buscas? Escríbenos.",
    "faq.search.placeholder": "Buscar preguntas...",
    "faq.no.results": "No encontramos preguntas que coincidan con tu búsqueda",
    "faq.try.again": "Intenta cambiar tu búsqueda o filtros",
    "faq.more.questions": "¿Tienes más dudas?",
    "faq.contact.support": "Escribe a nuestro equipo",
    ...
    "faq.questions.support": "¿Dais soporte después del lanzamiento?",
    "faq.questions.confidentiality": "¿Cómo sé que no me vais a robar la idea?",
    "faq.questions.pricing": "¿Tenéis opciones de pago flexibles?",
    "faq.questions.fundraising": "¿Me podéis ayudar a conseguir inversión?",

    // Answers
    "faq.answers.industries": "Somos expertos en <strong>MVPs de software</strong>, sobre todo para SaaS, apps con IA, plataformas digitales y herramientas de automatización. Si tu startup tiene que ver con software, IA o soluciones web, estamos aquí para ayudarte a crear un MVP potente y eficiente que llegue rápido al mercado.",
    "faq.answers.technical": "¡Para nada! <strong>Nosotros nos encargamos de toda la parte técnica</strong> y te explicamos todo de forma sencilla. Podrás tomar decisiones sobre tu MVP <strong>sin necesidad de ser un gurú tecnológico.</strong> Nuestro objetivo es darte el control sin complicarte la vida.",
    "faq.answers.feedback": "Antes de empezar a programar, definimos juntos lo <strong>esencial para tu MVP</strong>—asegurándonos de incluir solo lo que realmente necesitas. Si durante el proceso quieres añadir cambios o nuevas funciones, no hay problema, aunque <strong>puede haber costes adicionales</strong>. Somos flexibles pero sin perder de vista tus objetivos principales.",
    "faq.answers.fulldev": "¡Claro que sí! Si tu MVP tiene éxito, seguimos trabajando contigo para convertirlo en un <strong>producto completo</strong>—añadiendo nuevas funciones, integraciones y mejoras para impulsar tu crecimiento.",
    "faq.answers.support": "¡Por supuesto! Tenemos <strong>planes de soporte, mantenimiento y consultoría</strong> para que tu software siga funcionando perfectamente después del lanzamiento. Son opcionales y tienen un coste adicional, pero garantizan que tu producto se mantenga estable y listo para crecer.",
    "faq.answers.confidentiality": "Tranquilidad total. <strong>Tu idea es 100% tuya</strong>. Nos tomamos muy en serio la confidencialidad y firmamos un <strong>NDA (Acuerdo de Confidencialidad)</strong> o cualquier documento legal para proteger tu propiedad intelectual. Estamos aquí para construir tu visión, no para apropiarnos de ella.",
    "faq.answers.pricing": "¡Sí! Entendemos que cada startup tiene su propia situación financiera, así que ofrecemos <strong>precios y planes de pago flexibles</strong> adaptados a cada caso. Ya sea que necesites distribuir pagos en el tiempo o tengas un presupuesto ajustado, buscamos una solución que te funcione.",
    "faq.answers.fundraising": "Aunque <strong>no es nuestro servicio principal,</strong> tenemos bastante experiencia con <strong>aceleradoras, pitches de inversión y financiación de startups.</strong> Podemos darte consejos y ayudarte a preparar una presentación que enganche, pero nuestro foco principal sigue siendo construir tu MVP.",
  ...
  de: {
    ...
    "why.paragraph2.part1": "Wir wissen, wie frustrierend es ist, eine bahnbrechende Idee zu haben und ",
    "why.paragraph2.part2": "an unnötiger Komplexität zu scheitern",
    "why.paragraph2.part3": ". Genau deshalb sind wir hier - um ",
    "why.paragraph2.part4": "diese Barrieren aus dem Weg zu räumen",
    ...
    "roadmap.feature1.description.part1": "Wir verstehen, dass jedes großartige Produkt mit einer visionären Idee beginnt. Unser Fokus liegt darauf, ",
    "roadmap.feature1.description.part2": "Deine Vision zu bewahren",
    "roadmap.feature1.description.part3": " und gleichzeitig marktreif zu machen.",
    
    "roadmap.feature2.title": "Effiziente Entwicklung",
    "roadmap.feature2.description.part1": "",
    "roadmap.feature2.description.part2": "Keine unnötigen Funktionen",
    "roadmap.feature2.description.part3": ". Wir bauen genau das, was Du brauchst, um Deine Idee zu validieren und selbstbewusst im Markt zu testen.",
    
    "roadmap.feature3.title": "Skalierbarkeit inklusive",
    "roadmap.feature3.description.part1": "Wir fokussieren uns auf das Wesentliche des MVPs und stellen gleichzeitig sicher, dass Deine Software ",
    "roadmap.feature3.description.part2": "solide und skalierbar",
    "roadmap.feature3.description.part3": " für zukünftiges Wachstum ist.",
    
    // Roadmap Steps
    "roadmap.step.label": "Schritt",
    "roadmap.step1.title": "Ideenanalyse",
    "roadmap.step1.description.part1": "1. Wir tauchen in Deine Vision ein, um ",
    "roadmap.step1.description.part2": "deine Bedürfnisse zu verstehen und den Markt zu analysieren",
    "roadmap.step1.description.part3": ".",
    ...
    "roadmap.step2.description.part1": "2. Wir schärfen Dein Konzept und ",
    "roadmap.step2.description.part2": "setzen klare Prioritäten",
    "roadmap.step2.description.part3": " für eine smarte und (kosten-)effiziente Umsetzung.",
    ...
    "roadmap.step3.description.part1": "3. Wir definieren den Scope, setzen ",
    "roadmap.step3.description.part2": "klare Meilensteine und gestalten eine realistische Roadmap",
    "roadmap.step3.description.part3": ".",
    ...
    "roadmap.step4.description.part1": "4. ",
    "roadmap.step4.description.part2": "Transparenz, Zusammenarbeit und kontinuierliche Updates",
    "roadmap.step4.description.part3": " - Du behältst jederzeit die Kontrolle!",
    ...
    "roadmap.step5.title": "Launch & Support",
    "roadmap.step5.description.part1": "5. ",
    "roadmap.step5.description.part2": "Dein MVP ist marktreif",
    "roadmap.step5.description.part3": "! Wir ",
    "roadmap.step5.description.part4": "begleiten den Start",
    "roadmap.step5.description.part5": " und bieten langfristige Unterstützung.",
    ...
    "about.description.part1": "Wir kombinieren ",
    "about.description.part2": "tiefgreifende technische Expertise",
    "about.description.part3": " mit ",
    "about.description.part4": "Startup-Erfahrung",
    "about.description.part5": ", um Deine Vision in die Realität umzusetzen.",
    "about.robin.name": "Robin",
    "about.robin.title": "Startup- & Innovation-Lead",
    ...
    "comparison.our.service": "Wir",
    "comparison.traditional": "Agenturen",
    "comparison.nocode": "No-Code-Tools",
