...
const translations = {
  ...
  de: {
    // Hero Section
    "hero.title.fast": "Schnell. Intelligent.",
    "hero.title.mvp": "Ihr MVP richtig gemacht.",
    "hero.description": "Starten Sie Ihren Software-MVP in 6 Wochen und sparen Sie 30% der Entwicklungskosten.",
    "hero.button.estimate": "Erhalten Sie Ihre Preisschätzung",
    ...
    // Why We Do This Section
    "why.title": "Warum Wir Das Tun",
    "why.subtitle": "Wir glauben, dass jede mutige Idee eine Chance verdient.",
    "why.paragraph1": "Zu viele visionäre Gründer kämpfen darum, ihre Ideen zum Leben zu erwecken, weil sie <span className=\"font-semibold text-foreground\">Barrieren gegenüberstehen, die nicht existieren sollten</span>. Hohe Kosten aufgrund unnötiger Funktionen und schlechter Beratung töten großartige Konzepte, bevor sie überhaupt den Markt erreichen.",
    "why.paragraph2": "Wir haben das zu oft gesehen. Wir kennen die Frustration, eine bahnbrechende Idee zu haben, aber durch unnötige Komplexität zurückgehalten zu werden. <span className=\"font-semibold text-foreground\">Deshalb sind wir hier - um diese Barrieren abzubauen.</span>",
    
    // Roadmap Section
    "roadmap.title": "Wie Wir Es Umsetzen",
    "roadmap.subtitle": "Unser strukturierter Ansatz, um Ihre Vision in die Realität umzusetzen.",
    "roadmap.features.title": "Fahrplan zu Ihrem MVP",
    
    // Roadmap Features
    "roadmap.feature1.title": "Vision Zuerst Ansatz",
    "roadmap.feature1.description": "Wir verstehen, dass jedes großartige Produkt mit einer visionären Idee beginnt. Unser Fokus liegt darauf, Ihre Vision zu bewahren und gleichzeitig marktreif zu machen.",
    
    "roadmap.feature2.title": "Effiziente Entwicklung",
    "roadmap.feature2.description": "Keine unnötige Komplexität. Wir bauen genau das, was Sie brauchen, um Ihre Idee zu validieren und selbstbewusst in den Markt einzutreten.",
    
    "roadmap.feature3.title": "Zukunftssichere Grundlage",
    "roadmap.feature3.description": "Während wir uns auf das Wesentliche des MVP konzentrieren, stellen wir sicher, dass Ihr Fundament solide und skalierbar für zukünftiges Wachstum ist.",
    
    // Roadmap Steps
    "roadmap.step1.title": "Ideenanalyse",
    "roadmap.step1.description": "1. Wir tauchen in Ihre Vision ein, um Ihre Bedürfnisse zu verstehen und Ihren Markt zu analysieren.",
    "roadmap.step1.feature1.title": "Brancheneinblicke",
    "roadmap.step1.feature1.description": "Betrachtung von Markttrends und Branchendynamik, um den besten MVP für Sie zu entwickeln",
    "roadmap.step1.feature2.title": "Benutzerbedarfsanalyse",
    "roadmap.step1.feature2.description": "Tiefgreifende Analyse der Bedürfnisse und Schmerzpunkte Ihrer potenziellen Nutzer",
    "roadmap.step1.feature3.title": "Wettbewerbsanalyse",
    "roadmap.step1.feature3.description": "Verständnis Ihrer Marktposition und Wettbewerbsvorteile",
    "roadmap.step1.feature4.title": "Chancenvalidierung",
    "roadmap.step1.feature4.description": "Validierung der Marktpassung und des Potenzials Ihrer Idee",
    
    "roadmap.step2.title": "Intelligente Beratung",
    "roadmap.step2.description": "2. Wir beschneiden das Überflüssige und konzentrieren uns auf das, was für den Erfolg Ihres MVP wirklich wichtig ist",
    "roadmap.step2.feature1.title": "Funktionsanalyse",
    "roadmap.step2.feature1.description": "Identifizierung und Priorisierung wesentlicher MVP-Funktionen",
    "roadmap.step2.feature2.title": "Technische Architektur",
    "roadmap.step2.feature2.description": "Gestaltung der optimalen technischen Grundlage für Ihren MVP",
    "roadmap.step2.feature3.title": "Ressourcenplanung",
    "roadmap.step2.feature3.description": "Strategische Zuweisung von Ressourcen für maximale Effizienz",
    "roadmap.step2.feature4.title": "Risikominderung",
    "roadmap.step2.feature4.description": "Frühzeitige Identifizierung und Bewältigung potenzieller Herausforderungen",
    
    "roadmap.step3.title": "Umfang & Fahrplan",
    "roadmap.step3.description": "3. Wir definieren klare Projektgrenzen, Zeitplan und wichtige Lieferergebnisse, um eine effiziente Entwicklung zu gewährleisten.",
    "roadmap.step3.feature1.title": "Zeitplan-Definition",
    "roadmap.step3.feature1.description": "Erstellung eines klaren, erreichbaren Entwicklungszeitplans",
    "roadmap.step3.feature2.title": "Meilensteinplanung",
    "roadmap.step3.feature2.description": "Festlegung spezifischer, messbarer Projektmeilensteine",
    "roadmap.step3.feature3.title": "Projektumfang",
    "roadmap.step3.feature3.description": "Klare Erwartungen vermitteln",
    "roadmap.step3.feature4.title": "Lieferablen-Mapping",
    "roadmap.step3.feature4.description": "Definition klarer, umsetzbarer Projektlieferablen",
    
    "roadmap.step4.title": "Entwicklung",
    "roadmap.step4.description": "4. Wir bieten Ihnen einen transparenten Fortschritt, einschließlich enger Zusammenarbeit und regelmäßiger Updates. Sie haben immer die Kontrolle!",
    "roadmap.step4.feature1.title": "Agiler Prozess",
    "roadmap.step4.feature1.description": "Flexibler, iterativer Entwicklungsansatz",
    "roadmap.step4.feature2.title": "Qualitätsfokus",
    "roadmap.step4.feature2.description": "Rigorose Tests und Qualitätssicherung",
    "roadmap.step4.feature3.title": "Fortschrittsüberwachung",
    "roadmap.step4.feature3.description": "Regelmäßige Updates und Fortschrittsverfolgung",
    "roadmap.step4.feature4.title": "Kollaborative Entwicklung",
    "roadmap.step4.feature4.description": "Enge Partnerschaft während des gesamten Bauprozesses",
    
    "roadmap.step5.title": "Start & Support",
    "roadmap.step5.description": "5. Wir liefern Ihren MVP, bereit für den Markt. Bei Bedarf bieten wir Ihnen fortlaufende Unterstützung und Anleitung",
    "roadmap.step5.feature1.title": "Startstrategie",
    "roadmap.step5.feature1.description": "Umfassende Bereitstellungs- und Startplanung",
    "roadmap.step5.feature2.title": "Benutzerfeedback",
    "roadmap.step5.feature2.description": "Implementierung von Feedback-Sammelsystemen",
    "roadmap.step5.feature3.title": "Leistungsoptimierung",
    "roadmap.step5.feature3.description": "Sicherstellung optimaler MVP-Leistung",
    "roadmap.step5.feature4.title": "Fortlaufende Unterstützung",
    "roadmap.step5.feature4.description": "Kontinuierliche Anleitung und technischer Support",
    
    // Pricing Section
    "pricing.title": "Erhalten Sie Ihre Projektschätzung",
    "pricing.description": "Unser KI-Assistent hilft bei der Bewertung Ihres Projektumfangs, um Ihnen eine wettbewerbsfähige Preisschätzung zu bieten. Mit unserem intelligenten Planungsansatz können wir die Kosten erheblich senken und gleichzeitig die Qualität beibehalten.",
    "pricing.estimation": "Ihre Schätzung ist",
    "pricing.placeholder.input": "Nachricht eingeben...",
    "pricing.placeholder.locked": "Chat ist gesperrt. Drücken Sie Reset, um neu zu beginnen.",
    
    // BannerCTA Section
    "banner.title": "Wir sind nicht nur MVP-Entwickler",
    "banner.description": "Wir sind Problemlöser, Geschäftsdenker und Startup-Insider. Wir glauben an die Schaffung von echtem Mehrwert. Wenn Sie die Vision haben, haben wir den Fahrplan, um sie zu verwirklichen!",
    "banner.button": "Jetzt Starten",
    
    // CTA Section
    "cta.title": "Bereit, das nächste große Ding zu bauen? Sprechen wir!",
    "cta.description": "Starten Sie jetzt. Der <span class=\"font-semibold text-foreground\">richtige MVP</span> zum <span class=\"font-semibold text-foreground\">richtigen Preis</span>—nicht mehr, nicht weniger. Wir sind nur <span class=\"font-semibold text-foreground\">einen Klick entfernt</span>.",
    "cta.email": "E-Mail",
    "cta.linkedin": "LinkedIn",
    "cta.form.email": "E-Mail",
    "cta.form.email.placeholder": "ihre@beispiel.de",
    "cta.form.message": "Nachricht",
    "cta.form.message.placeholder": "Erzählen Sie uns von Ihrem Projekt...",
    ...
    "about.robin.name": "Robin",
    "about.robin.title": "Startup & Innovationsleiter",
    "about.robin.mission": "Komplexe Ideen in fokussierte, marktreife MVPs umwandeln",
    "about.robin.achievement": "10+ erfolgreiche MVPs eingeführt",
    "about.robin.skill1": "MVP-Strategie",
    "about.robin.skill2": "IT-Produktentwicklung",
    "about.robin.skill3": "Marktanalyse",
    "about.robin.skill4": "Growth Hacking",
    "about.robin.skill5": "Teamführung",
    "about.chris.name": "Chris",
    "about.chris.title": "Technische Architektur & KI-Leiter",
    "about.chris.mission": "Skalierbare Grundlagen für die Innovationen von morgen aufbauen",
    "about.chris.achievement": "12+ Jahre technische Erfahrung",
    "about.chris.skill1": "Systemarchitektur",
    ...
    // ComparisonMatrix Section
    "comparison.title": "Wählen Sie Ihre perfekte Lösung",
    "comparison.description": "Vergleichen Sie Ansätze und finden Sie die beste Lösung für Ihre MVP-Entwicklungsbedürfnisse.",
    "comparison.hover": "Bewegen Sie den Mauszeiger über ein Symbol für eine ausführlichere Erklärung",
    ...
    "faq.subtitle": "FAQ",
    "faq.description": "Finden Sie Antworten auf häufig gestellte Fragen zu unserem MVP-Entwicklungsprozess und unseren Dienstleistungen. Können Sie nicht finden, wonach Sie suchen? Kontaktieren Sie unser Team.",
    "faq.search.placeholder": "Fragen durchsuchen...",
    "faq.no.results": "Keine Fragen gefunden, die Ihren Kriterien entsprechen",
    "faq.try.again": "Versuchen Sie, Ihre Suche oder Filter anzupassen",
    "faq.more.questions": "Haben Sie noch Fragen?",
    "faq.contact.support": "Kontaktieren Sie unser Support-Team",
    ...
    // Questions
    "faq.questions.industries": "Auf welche Branchen oder Arten von Startups sind Sie spezialisiert?",
    "faq.questions.technical": "Muss ich technisches Wissen haben, um mit Ihnen zusammenzuarbeiten?",
    "faq.questions.feedback": "Wie gehen Sie mit Feedback und Änderungen während der Entwicklung um?",
    "faq.questions.fulldev": "Wenn ich meinen MVP zu einem vollständigen Produkt machen möchte, können Sie den gesamten Entwicklungszyklus übernehmen?",
    "faq.questions.support": "Bieten Sie After-Launch-Support oder Wartung an?",
    "faq.questions.confidentiality": "Kann ich darauf vertrauen, dass Sie meine Idee nicht stehlen?",
    "faq.questions.pricing": "Bieten Sie Zahlungspläne oder flexible Preisgestaltung an?",
    "faq.questions.fundraising": "Können Sie bei der Mittelbeschaffung oder bei Präsentationen für Investoren helfen?",

    // Answers
    "faq.answers.industries": "Wir konzentrieren uns auf <strong>Software-MVPs</strong>, insbesondere für SaaS, KI-gestützte Anwendungen, digitale Plattformen und Automatisierungstools. Wenn Ihr Startup Software, KI oder webbasierte Lösungen umfasst, sind wir hier, um Ihnen beim Aufbau eines schlanken, wirkungsvollen MVP zu helfen, der Sie schnell auf den Markt bringt.",
    "faq.answers.technical": "Überhaupt nicht! <strong>Wir kümmern uns um alle technischen Details</strong> und halten Sie auf einfach verständliche Weise auf dem Laufenden. Wir stellen sicher, dass Sie die richtigen Entscheidungen über Ihren MVP treffen können, <strong>ohne ein technischer Experte sein zu müssen.</strong> Unser Ziel ist es, Sie zu befähigen, ohne Sie zu überfordern.",
    "faq.answers.feedback": "Bevor die Entwicklung beginnt, arbeiten wir eng mit Ihnen zusammen, um den <strong>wesentlichen MVP-Umfang zu definieren</strong> – und stellen sicher, dass er alles enthält, was Sie brauchen, und nichts, was Sie nicht brauchen. Wenn Sie während des Prozesses Änderungen oder zusätzliche Funktionen benötigen, ist das durchaus möglich, obwohl <strong>zusätzliche Kosten anfallen können</strong>. Wir bewahren Flexibilität zur Anpassung, während wir Ihre Ziele im Auge behalten.",
    "faq.answers.fulldev": "Absolut! Wenn sich Ihr MVP als erfolgreich erweist, können wir weiter mit Ihnen zusammenarbeiten, um ihn zu einem <strong>vollständig entwickelten Produkt</strong> zu skalieren – mit neuen Funktionen, Integrationen und Optimierungen zur Unterstützung Ihres Wachstums.",
    "faq.answers.support": "Ja, das tun wir! Wir bieten <strong>laufende Support-, Wartungs- und Beratungspakete</strong> an, um Ihre Software und Ihr Projekt nach dem Start reibungslos laufen zu lassen. Diese Dienste sind optional und zu zusätzlichen Kosten erhältlich, um sicherzustellen, dass Ihr Produkt stabil und bereit für Wachstum bleibt.",
    "faq.answers.confidentiality": "Absolut. <strong>Ihre Idee bleibt zu 100% Ihre</strong>. Wir nehmen Vertraulichkeit sehr ernst und unterzeichnen gerne eine <strong>NDA (Geheimhaltungsvereinbarung)</strong> oder ein anderes rechtliches Dokument zum Schutz Ihres geistigen Eigentums. Wir sind hier, um Ihre Vision aufzubauen – nicht, um sie zu übernehmen.",
    "faq.answers.pricing": "Ja! Wir verstehen, dass Startups verschiedene finanzielle Situationen haben, daher bieten wir <strong>flexible Preismodelle und Zahlungspläne</strong> von Fall zu Fall an. Ob Sie Zahlungen über einen Zeitraum verteilen oder mit einem engen Budget arbeiten müssen, wir sind offen dafür, eine Lösung zu finden, die zu Ihnen passt.",
    "faq.answers.fundraising": "Obwohl <strong>es nicht unser Kerngeschäft ist,</strong> haben wir wertvolle Erfahrung mit <strong>Accelerators, Investorenpräsentationen und Startup-Finanzierung.</strong> Wir können Anleitung, Einblicke geben und Ihnen helfen, eine überzeugende Präsentation zu erstellen, aber unser Hauptfokus bleibt der Aufbau Ihres MVP.",
    
    // Chat Sequences
    "chat.sarah.name": "Sarah Chen",
    "chat.sarah.message": "Können Sie eine Mobile-First-SaaS-Plattform entwickeln?",
    ...
    "chat.marcus.features.startup.title": "Startup-bereite Funktionen",
    ...
    "chat.elena.response": "Wir erstellen ein einzigartiges E-Commerce-Erlebnis, das Sie abhebt. Hier ist unser maßgeschneiderter Ansatz:",
    ...
    "chat.lisa.response": "Wir helfen Ihnen, KI zu nutzen, um überzeugenden Mehrwert für Ihre Kunden zu schaffen. Unser Beratungsprozess umfasst:",
    ...
    "chat.rachel.response": "Wir erstellen eine KI-gestützte Content-Beschleunigungsplattform, die auf Ihre Marke zugeschnitten ist. Hier ist unsere Lösung:",
